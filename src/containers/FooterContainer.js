  ...
  return (
    <Footer>
      <Footer.Container>
        <Footer.Content>
          <Footer.Item>
            <Footer.Title>Chamber Finder</Footer.Title>
            <Footer.Text>
              1337 Fake Street,New Jersey
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
              ...
              <Footer.ListItem>
                ...
                <Footer.Text>ChamberFinder@gmail.com</Footer.Text>
              </Footer.ListItem>
            </Footer.List>
          </Footer.Item>
          <Footer.Item>
      ...
      <Footer.Bottom>
        <Footer.Container>
          <Footer.Text>&copy; Chamber Finder. All Rights Reserved</Footer.Text>
        </Footer.Container>
      </Footer.Bottom>
    </Footer>
  );
